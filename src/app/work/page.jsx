...
export const metadata = {
  title: "Veni portfolio",
  description:
" We've worked with a wide range of clients, from small startups to large corporations. Check out our portfolio to see some of our recent work.",
};
