...
export const metadata = {
  title: "Contact us - Veni Development",
  description: //call to action
    " Here at Veni Development, we are committed to providing you with the best service possible. Contact us today to get started on your next project.",
};

export default function ContacttWOPage() {
  return (
          ...
          <div className="flex flex-col items-start justify-between sm:items-center lg:items-start">
            ...
            <div>
              ...
              <div className="w-full mt-4 text-left md:mt-5 sm:text-center lg:text-left">
                ...
                Contact us today to get started on your next project and we'll get
                  back to you shortly.
                </p>
              </div>
            </div>
