...
const features = [
  {
    ...
    headline: " Modern and Innovative digital solutions",
    text: "We specialize in crafting innovative digital products that are perfectly suited to your brand's needs. From ideation to execution, we turn ideas into tangible realities",
    image: {
      src: image1,
  ...
  },
  {
    ...
    text: "Design: We design for better user experiences, focusing on simplicity and functionality. We create beautiful, intuitive interfaces that are easy to use and understand.",
    image: {
      src: image2,
  ...
  },
  {
    ...
    headline: "State of the art performance optimization",
