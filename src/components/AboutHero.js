    ...
    <section className="px-4 pt-12 pb-10 md:pb-12 md:pt-16 sm:px-6 lg:px-8">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="w-full max-w-4xl mx-auto text-center lg:max-w-5xl">
          <p className="inline-flex items-center justify-center px-6 py-2 text-sm font-medium tracking-wide text-white rounded-r-full rounded-tl-full bg-gradient-to-r from-dark-600 to-dark-700"></p>
