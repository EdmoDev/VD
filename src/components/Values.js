...
const values = [
  {
    ...
    text: "We guarantee the quality and reliability of our products and services. ",
    icon: "flame",
  },
  {
    value: "Scalability and Flexibility",
    text: "Our solutions are designed to be scalable and flexible, allowing for future growth and expansion.",
    icon: "trendingUp",
  },
  {
    value: "Continuous Support and Maintenance",
    text: " We are committed to providing our clients with the best support possible.",
    icon: "users",
  },
];
      ...
      <div className="w-full max-w-screen-xl mx-auto">
        ...
        <div className="w-full max-w-xl mx-auto text-center lg:max-w-3xl md:max-w-2xl">
          ...
          <p className="mt-6 text-xl text-dark-300">
            ...
            have been working together for over 10 years. We have a proven track
            record of delivering high quality solutions to our clients.
          </p>
        </div>
          ...
          {values.slice(0, 3).map((item, index) => (
            ...
            >
              <div className="max-w-sm mx-auto text-center">
                <span className="flex items-center justify-center mx-auto shadow-inner bg-gradient-to-r rounded-3xl w-18 h-18 from-dark-800 to-dark-900 shadow-inner-clay">
                  <Icon
                    name={item.icon}
