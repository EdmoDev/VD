    ...
    <div className="mt-12 space-y-12 lg:mt-16 lg:space-y-56 lg:pb-24">
      {caseStudies.map((caseStudy, index) => (
        ...
        >
          ...
          <div
            className={clsx(
              "relative bottom-0 z-20 block w-full h-auto p-6  lg:rounded-3xl rounded-b-3xl sm:p-8 lg:p-12 bg-opacity-50 backdrop-filter backdrop-blur-lg bg-black lg:absolute lg:-bottom-25 lg:w-1/3 lg:h-full   shadow-inner-clay",
