...
const features = [
  {
    ...
    headline: " Build a Brand That Matters",
    text: "We help you build a brand that resonates with your audience. From brand strategy to digital product development, our solutions are designed to help your business grow.",
    image: {
      src: featureImage1,
    ...
    list: [
      //stretigic
      { text: "Deep understanding of your market and target audience" },
      { text: "Comprehensive brand strategy that aligns with your goals" },
      {
        text: "Clear and concise brand messaging that resonates with your audience",
      },
    ],
  },
  {
    ...
    text: "We fuel your enterprise with innovation, redefining the limits with progressive solutions. From digital landscapes to brand narratives, our work propels your business to new heights.",
    image: {
      src: featureImage2,
      alt: "Two people brainstorming on table",
    },
    list: [
      { text: "Cutting-edge digital product development that meets the needs of your customers" },
      { text: "Optimized marketing strategies that drive growth" },
      { text: "Impactful narratives that connect with your audience and inspire them to take action" },
    ],
  },
];
